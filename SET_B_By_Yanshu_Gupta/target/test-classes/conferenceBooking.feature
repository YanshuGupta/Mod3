Feature: This Feature file will check the Conferance Registration page 

Scenario: User will try to book conference room with invalid information 

	Given User is on Conference room booking page 
	Then The Title of the Page must be "Conference Registartion" 
...
Scenario: User will try to book conference room with Valid information 
	Given User is on Conference room booking page 
